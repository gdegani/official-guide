\documentclass[italian,12pt,a4paper,parskip=full]{scrartcl}
\usepackage{float}
\usepackage{bbding}
\usepackage{pifont}
\usepackage{wasysym}
...
framework per sviluppare, consegnare e mantenere prodotti complessi da parte di
 un singolo team. Fin dalla nascita, il suo uso si è esteso alla creazione di
prodotti, processi, servizi e sistemi che richiedono il lavoro di più team.
Scrum@Scale è stato creato per coordinare efficientemente questo nuovo 
ecosistema di team in modo da ottimizzare la strategia 
...
Questa guida contiene la definizione dei componenti che costituiscono Scrum@Scale, includendo i corrispondenti su larga scala dei ruoli, degli eventi, dei manufatti di Scrum, e le regole che li tengono insieme.

Il Dr. Jeff Sutherland ha sviluppato Scrum@Scale basandosi sui principi fondamentali di Scrum, sulla teoria dei sistemi adattivi complessi, sulla teoria dei giochi e sul suo lavoro in biologia. Questa guida è stata sviluppata grazie ai suggerimenti di numerosi esperti praticanti di Scrum ed è basata sui risultati del loro lavoro. 
...
il risultato (prodotto funzionante) e la velocità (produttività misurata a fine sprint - ndt) di questi team iniziavano a decadere (a causa di problemi come le dipendenze tra team e la duplicazione del lavoro). Diventò quindi ovvio che serviva una infrastruttura per coordinare 
efficacemente questi team in modo da ottenere una scalabilità lineare.
Scrum@Scale è stato progettato per raggiungere questo obiettivo grazie alla
sua architettura scale-free.

Le architetture scale-free sono comuni nei sistemi biologici come il corpo umano, e nella progettazione di circuiti integrati che richiede di inserire miliardi di transistor in un chip. Utilizzando un'architettura scale-free, l'organizzazione non è 
...
accettato dai gruppi e dagli individui che compongono l'organizzazione. La semplicità del modello Scrum@Scale è essenziale per una architettura scale-free ed evita attentamente di introdurre della complessità aggiuntiva che provocherebbe una diminuzione della produttività del singolo team al crescere del numero di team.

Scrum@Scale è progettato per estendersi lungo tutta l'organizzazione: tutti
i dipartimenti, prodotti e servizi. Può essere applicato in diversi domini
e su qualsiasi tipo di organizzazione nell'industria, nei governi o nelle accademie. Scrum@Scale consente ad intere organizzazioni di produrre più valore ad un ritmo più rapido ma comunque sostenibile.

\subsection{Definizione di Scrum@Scale}
\textbf{Scrum}: Un framework con cui le persone possono risolvere problemi adattivi complessi,
realizzando creativamente prodotti o servizi con il più alto valore possibile.
...
\textbf{Scrum@Scale}: Un framework con cui una rete di team Scrum opera in maniera consistente
alla Scrum Guide per affrontare problemi adattivi complessi producendo creativamente prodotti  o servizi del più alto valore possibile.
\textbf{NOTA:} Questi ``prodotti'' possono essere hardware, software, sistemi complessi integrati, processi, servizi, ecc., a seconda del dominio dei team Scrum. Questi “servizi” possono essere servizi di supporto, di riparazione, di manutenzione o servizi governativi.
 
Scrum@Scale è:
\begin{itemize}
\item Leggero - la minima burocrazia possibile
...
Scrum@Scale è un framework per scalare Scrum (estendere Scrum ad una scala più ampia - ndt). Semplifica radicalmente l'estensione in quanto usa Scrum per scalare Scrum.

Scrumm@Scale costiste di componenti che consentono ad una organizzazione di personalizzare la propria strategia di trasformazione ed implementazione. Permette di indirizzare le azioni di cambiamento incrementalmente, dando priorità alle aree che si ritiene più importanti o più bisognose di cambiamento, e di progredire successivamente nelle altre.

In Scrum, la rimozione degli impedimenti è un componente centrale per aumentare la velocità del team.In Scrum@Scale la rimozione degli impedimenti è applicata estensivamente per aumentare la velocitòà dell'intera organizzazione.

In Scrum, è stato separata con cura la responsabilità del ``cosa'' dal ``come''.
La stessa cura è stata mantenuta in Scrum@Scale in modo che la giurisdizione e le responsabilità siano chiaramente comprese in modo da eliminare conflitti organizzativi e sprechi che impediscano ai team di raggiungere la loro produttività ottimale.
...
Scrum@Scale può essere applicato quando un'organizzazione ha posizioni organizzative che corrispondono ai ruoli di Scrum. In altre parole, Scrum@Scale funziona se titoli professionali quali Scrum Master e Product Owner definiscono delle posizioni all'interno dell'organizzazione. Scrum@Scale funziona anche quando le posizioni organizzative non corrispondono ai ruoli Scrum. In questi casi una persona può essere assunta come progect manager (posizione) ma può servire un team Scrum come Product Owner (ruolo). Non ci sono conflitti fra ruoli e posizioni. Nelle organizzazioni agili dove ruoli (Scrum Master) e posizioni (regional manager) non corrispondono, bisogna dedicare molta attenzione alla loro armonizzazione. Armonizzare ruoli e posizioni può essere importante per l'estensione (scaling) di Scrum come ogni altro fattore. Organi di gestione e controllo aziendale, ruoli e posizioni dovrebbero essere allineati in ogni organizzazione che applica Scrum per garantire che Scrum possa scalare e mantenere sia la velocità dei team che la loro capacità di creare prodotti o servizi di valore. Gli organi aziendali di gesione e controllo dovrebbero rivolgersi a chi ha l'autorità di rimuovere gli impedimenti.
